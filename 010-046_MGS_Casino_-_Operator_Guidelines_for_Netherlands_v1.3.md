...
source_file: 010-046 MGS Casino - Operator Guidelines for Netherlands v1.3.pdf
...
| 6503 | The player has insufficient funds. |
...
A central register system across all game forms shall be maintained to protect players and combat addiction to games of chance. MGS Casino has no visibility of your players prior to launching a MGS game. As such, please ensure that your players are not on the central exclusion register. Any player on the central register system, must not be allowed to launch any game. Please ensure that any player on the central register system, be excluded from all brands for your casino.
